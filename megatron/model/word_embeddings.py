...
from megatron.model.init_functions import get_init_methods, init_method_uniform
...
class Embedding(torch.nn.Module):
    ...
    def __init__(
        ...
        self.small_init_emb_and_layernorm = neox_args.small_init_emb_and_layernorm
        if self.small_init_emb_and_layernorm:
            self.norm = torch.nn.LayerNorm(self.hidden_size)
            self.init_method = init_method_uniform(-1e-4, 1e-4)
